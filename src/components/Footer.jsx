...
//   return (
//     <div className="bg-indigo-600 flex flex-col justify-between gap-y-3 p-6 rounded-t-3xl mt-24 xl:p-8">
...
//             <div className="text-[#ffffff] font-semibold text-2xl sm:text-3xl md:text-4xl lg:text-5xl mb-1">
...
export default function Footer() {
  return (
    <div className="flex flex-col gap-4 mt-24 px-4 md:px-8 mb-8 max-w-7xl mx-auto">
      
      {/* Main Top Footer Block */}
      <div className="bg-indigo-600 flex flex-col lg:flex-row justify-between gap-y-6 p-4 lg:p-8 rounded-4xl">
        ...
        <div className="bg-[#2A2A2A] rounded-3xl p-8 sm:p-10 flex flex-col gap-3 w-full lg:w-auto min-w-[350px] shadow-lg">
          ...
          <Link
            href={`mailto:${urlData.email}`}
            className="text-white text-xl sm:text-2xl underline underline-offset-4 decoration-1 tracking-wide hover:text-gray-300"
          >
            {urlData.email}
          </Link>
          ...
          <div className="flex flex-row justify-start gap-4 mt-6 flex-wrap">
            {urlData.whatsapp && (
              <Link href={urlData.whatsapp} target="_blank" rel="noreferrer" className="bg-[#d9d9d9] hover:bg-indigo-600 rounded-full w-12 h-12 flex justify-center items-center hover:scale-105 transition-transform">
                <svg
            ...
            {urlData.telegram && (
              <Link href={urlData.telegram} target="_blank" rel="noreferrer" className="bg-[#d9d9d9] hover:bg-indigo-600 rounded-full w-12 h-12 flex justify-center items-center hover:scale-105 transition-transform">
                <svg
                  className="stroke-[#141414] stroke-2"
                  xmlns="http://www.w3.org/2000/svg"
                  height="30"
            ...
            {urlData.instagram && (
              <Link href={urlData.instagram} target="_blank" rel="noreferrer" className="bg-[#d9d9d9] hover:bg-indigo-600 rounded-full w-12 h-12 flex justify-center items-center hover:scale-105 transition-transform">
                <svg
                  className="stroke-[#141414] stroke-2"
                  xmlns="http://www.w3.org/2000/svg"
                  height="30"
            ...
            {urlData.twitter && (
              <Link href={urlData.twitter} target="_blank" rel="noreferrer" className="bg-[#d9d9d9] hover:bg-indigo-600 rounded-full w-12 h-12 flex justify-center items-center hover:scale-105 transition-transform">
                <svg
                  className="stroke-[#141414] stroke-2"
                  xmlns="http://www.w3.org/2000/svg"
                  height="30"
            ...
            {urlData.youtube && (
              <Link href={urlData.youtube} target="_blank" rel="noreferrer" className="bg-[#d9d9d9] hover:bg-indigo-600 rounded-full w-12 h-12 flex justify-center items-center hover:scale-105 transition-transform">
                <svg
                  className="stroke-[#141414] stroke-2"
                  xmlns="http://www.w3.org/2000/svg"
                  height="30"
      ...
      <div className="bg-indigo-600 rounded-4xl p-6 lg:px-12 flex flex-col sm:flex-row justify-between items-center gap-4">
