  ...
  return (
    <div>
      <nav className="absolute w-full bg-transparent z-50">
        <div className="flex flex-wrap justify-between items-center mt-0 max-w-full p-2">
          <div
            onClick={() => scrollToSection("homepage")}
            className="flex justify-start items-center cursor-pointer"
          >
            <div className="text-gray-800 flex flex-row justify-center items-end text-3xl font-semibold">
              <Image src="/aksh.svg" width={40} height={40} alt="aksh" />
              <Image
          ...
          <div className="md:hidden flex relative">
            <div className="flex fixed top-4 right-4 z-50">
              <button
                onClick={openModal}
                className="border-2 border-[#20DDBC] hover:border-indigo-600 text-gray-800 p-2 rounded-full bg-white"
              >
                <svg
              ...
              <Modal isOpen={isModalOpen} onClose={closeModal}>
                <div className="w-full h-full flex flex-col justify-start mt-8">
                  
                  {/* Top Links Section */}
                  <div className="mb-4">
                    <ul className="flex flex-col gap-2 text-3xl sm:text-4xl font-normal text-black tracking-wide">
                  ...
                  {/* Dark "Get In Touch" Block */}
                  <div className="bg-[#303030] rounded-2xl p-6 sm:p-8 flex flex-col gap-6 w-full shadow-lg">
                    <div className="flex flex-col gap-2">
                      <p className="text-indigo-600 text-2xl sm:text-3xl font-normal tracking-wide mb-2">
                        Get In Touch
                      </p>
                      
                      <Link
                        href={`mailto:${urlData.email}`}
                        className="text-white text-xl sm:text-2xl underline underline-offset-4 tracking-wide"
                      >
                        {urlData.email}
                      </Link>
                    ...
                    <div className="flex flex-row justify-start gap-4 mt-2 flex-wrap">
                      {urlData.whatsapp && (
                        <Link
                          href={urlData.whatsapp}
                          target="_blank"
                          rel="noreferrer"
                          className="bg-[#d9d9d9] rounded-full w-10 h-10 flex justify-center items-center hover:scale-105 transition-transform"
                        >
                          <svg
